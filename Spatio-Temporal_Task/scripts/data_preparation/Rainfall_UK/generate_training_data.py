...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_file_path", type=str,
                        default=DATA_FILE_PATH, help="Raw readings.")
    parser.add_argument("--graph_file_path", type=str,
                        default=GRAPH_FILE_PATH, help="Raw readings.")
    ...
    parser.add_argument("--dom", type=bool, default=TOD,
                        help="Add feature day of month.")
    parser.add_argument("--moy", type=bool, default=DOW,
                        help="Add feature month of year.")
...
# python scripts/data_preparation/Rainfall_UK/generate_training_data.py --history_seq_len 30 --future_seq_len 7